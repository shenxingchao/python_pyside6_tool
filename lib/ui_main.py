...
################################################################################
## Form generated from reading UI file 'mainevOBPa.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.main_top_layout.addWidget(self.btn3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn3.setText(QCoreApplication.translate("MainWindow", u"\u5360\u4f4d", None))
